        ...
        <div className="flex flex-row flex-wrap -mx-3 md:pb-7">
          <div className="xl:w-5/12 px-3 w-full pt-7">
            ...
            <p className="text-[#cccccc] text-base font-inter leading-[25px] lg:max-w-[369px] pt-6 font-medium">
              En Exclusive Games somos un equipo apasionado de personas dedicadas al desarrollo de
            ...
            <div className="flex gap-3 pt-4">
              {/* <a
                ...
                target="_blank"
                className=" hover:translate-y-[-5px] hover:shadow-[0px_5px_8px_#fff] transition-all ease-linear duration-500 rounded-[50px] "
              >
                <svg
                  width="32"
                  height="32"
              ...
              <div className="md:w-4/12 w-1/2 flex lg:justi fy-end">
                <ul>
                  ...
                  <li className="flex gap-2 items-center pb-3 sm:pb-4">
                    ...
                    <a
                      href=""
                      className="text-[#cccccc] text-base font-Inter leading-[25px] hover:text-[#ffff] transition-all duration-500">
